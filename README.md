...
This is a Novel View Synthesis model, where given a set of images from a 3D scene with their camera properties/pose,
the model aims to generate a new view in the scene, given the target camera properties and pose.
