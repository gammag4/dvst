...
class DVSTConfig:
    def __init__(self, frames_per_scene=3, N_enc=2, N_dec=7, n_heads=12, d_lat=128, e_ff=2, n_lat=1024, p=16, n_oct=6, C=3, latent_aggregator=regular_latent_aggregator):
