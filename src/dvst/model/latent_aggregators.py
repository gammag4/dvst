...
def regular_latent_aggregator(self: DVSTEncoder, latent_embeds, next_frames_embeds):
    # latent_embeds: (B, n_lat, d_model), next_frames_embeds
    ...
    embeds = torch.concat([next_frames_embeds, current_latent_embeds], dim=-2) # Concats embeddings with frame embeddings
