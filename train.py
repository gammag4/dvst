...
from src.base.run import SetupFactory, DistributedTrainer
from src.base.config import Config

from src.dvst import create_config
from src.dvst import DVSTTrainer
from src.dvst import DVSTSetupFactory


if __name__ == '__main__':
    # TODO maybe use pydantic
    config: Config = create_config()
    setup_factory: SetupFactory = DVSTSetupFactory(config)
    trainer: DistributedTrainer = DVSTTrainer(config, setup_factory)
